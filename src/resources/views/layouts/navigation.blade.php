<nav x-data="{ open: false }" class="Navmenu">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="navlink">
                        {{ __('หน้าแรก') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('employ.index')" :active="request()->routeIs('employ')" class="navlink">
                        {{ __('พนักงาน') }}
                    </x-nav-link>
